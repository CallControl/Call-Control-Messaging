...
public final class BackupActivity_MembersInjector implements MembersInjector<BackupActivity> {
  ...
  public BackupActivity_MembersInjector(
  ...
  public static MembersInjector<BackupActivity> create(
      Provider<Colors> colorsProvider,
      Provider<ConversationRepository> conversationRepoProvider,
      Provider<MessageRepository> messageRepoProvider,
      Provider<PhoneNumberUtils> phoneNumberUtilsProvider,
      Provider<Preferences> prefsProvider) {
    return new BackupActivity_MembersInjector(
        colorsProvider,
  ...
  @Override
  public void injectMembers(BackupActivity instance) {
