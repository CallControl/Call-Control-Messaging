...
public abstract interface ContactRepository {
    ...
    @org.jetbrains.annotations.NotNull
    public abstract io.realm.RealmResults<dev.octoshrimpy.quik.model.Contact> getContacts();
    
    @org.jetbrains.annotations.Nullable
    public abstract dev.octoshrimpy.quik.model.Contact getUnmanagedContact(@org.jetbrains.annotations.NotNull
    java.lang.String lookupKey);
    
    @org.jetbrains.annotations.NotNull
    public abstract io.reactivex.Observable<java.util.List<dev.octoshrimpy.quik.model.Contact>> getUnmanagedContacts(boolean starred);
    
    @org.jetbrains.annotations.NotNull
    public abstract io.reactivex.Observable<java.util.List<dev.octoshrimpy.quik.model.ContactGroup>> getUnmanagedContactGroups();
